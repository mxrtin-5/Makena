...
import styles from './DetailDestacados.module.css'


const DetalleDestacados = () => {
    ...
    useEffect(() => {
        const fetchProducto = async () => {
            try {
                const productoRef = doc(db, 'destacados', id);
            ...
            <div className={styles.prod}>
                {productos && (
                    <div className={styles.divProd}>
                        <h1 className={styles.name}>{productos.name}</h1>
                        <img className={styles.image} src={productos.image} alt="" />
                        <div className={styles.buttons}>
                            <p><span>Price:</span>${productos.price}</p>
                            <button onClick={() => agregarAlCarrito(productos)} className={styles.button2}>
                                Agregar al carrito
                            </button>
                        </div>
                    </div>
...
export default DetalleDestacados;