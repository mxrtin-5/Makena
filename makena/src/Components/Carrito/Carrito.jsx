            ...
            <div className={styles.containerCartProducts}>
                <div className={styles.cartProducts}>
                    {cart.length === 0 ? (
                        ...
                        cart.map((product) => (
                            <div key={product.id} className={styles.cartProduct} onClick={handleProductClick}>
                                <div className={styles.infoCartProduct}>
                                    ...
                                    <div className={styles.contenedorButtons}>
                                        <button className={styles.buttones} onClick={() => decrementarCantidad(product.id)}>-</button>
                                        <div>{product.counter}</div>
                                        <button className={styles.buttones} onClick={() => incrementarCantidad(product.id)}>+</button>
